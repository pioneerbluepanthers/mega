...
ADAMB1=0.89
ADAMB2=0.98
EHD=150 #at most, 240 - reasonable number, 48
ENCODERLAYER=3 # 3, 4, 5, 6
run_name="lr=${LR}_B1=${ADAMB1}_eps=${ADAMEPS}_B2=${ADAMB2}_EHD=${EHD}_ENCODERLAYER=${ENCODERLAYER}"
#run_name="test1"
seed=42
...
python -u train.py ${DATA} \
    ...
    --sentence-class-num 5 --max-positions 1000 --encoder-embed-dim 12 --wandb-project "multilabel development" --encoder-hidden-dim $EHD\
